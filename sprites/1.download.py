...
achis = re.findall(r'div class="achievement" id="achievement-([0-9]+)"', html_from_steamdb.html)
...
for i in tqdm(range(0,2 * ACHIEVEMENT_COUNT, 2)):
    ...
    bin = requests.get("https://shared.fastly.steamstatic.com/community_assets/images/apps/250900/" + datas[i+1]).content
